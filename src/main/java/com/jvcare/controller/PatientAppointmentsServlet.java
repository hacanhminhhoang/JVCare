...
public class PatientAppointmentsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (patient != null) {
            List<Appointment> allList = appointmentDAO.getAppointmentsByPatientId(patient.getPatientId());
            ...
            List<Appointment> pageList = (start < totalItems) ? allList.subList(start, end) : new java.util.ArrayList<>();
            
            request.setAttribute("appointments", pageList);
