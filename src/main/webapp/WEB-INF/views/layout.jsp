...
<body class="min-h-screen bg-background text-foreground antialiased selection:bg-brand/20 selection:text-brand-foreground">
    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <main class="flex-1 overflow-y-auto">
            <header class="sticky top-0 z-10 flex h-16 shrink-0 items-center justify-between border-b border-border/40 bg-background/80 px-6 backdrop-blur-md">
                <div class="flex items-center">
                    <!-- Mobile Menu Button -->
                </div>
                <div class="flex items-center gap-4">
                    <div class="h-8 w-8 rounded-full bg-brand-soft text-brand flex items-center justify-center font-bold">BN</div>
                </div>
            </header>
