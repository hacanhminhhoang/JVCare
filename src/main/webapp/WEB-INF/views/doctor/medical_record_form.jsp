        ...
        <body class="min-h-screen bg-background font-sans text-ink flex">
            ...
            <main class="flex-1 overflow-auto bg-muted/30">
                ...
                <div class="mx-auto max-w-4xl p-6 md:p-10">
                    ...
                    <div class="mb-4">
                        <a href="${pageContext.request.contextPath}/doctor/medical-records"
                            class="inline-flex items-center gap-1.5 text-sm font-semibold text-muted-foreground hover:text-brand transition">
                    ...
                    <div class="mb-8">
                        ...
                        <p class="mt-1 text-sm text-muted-foreground">
                            ${record != null ? 'Thay đổi thông tin chẩn đoán, điều trị của bệnh án hiện có' : 'Nhập
                            thông tin thăm khám lâm sàng và đưa ra phương án điều trị mới'}
                        </p>
                    </div>
                        ...
                        <form method="post" action="${pageContext.request.contextPath}/doctor/medical-records"
                            ...
                            <c:choose>
                                <c:when test="${appointment != null}">
                                    <div
                                        class="rounded-2xl border border-brand/20 bg-brand-soft/20 p-5 flex items-start gap-4 shadow-inner">
                                        ...
                                        <div class="text-sm">
                                            <span class="text-xs font-bold uppercase tracking-wider text-brand">Hồ sơ
                                                bệnh nhân từ lịch hẹn</span>
                                            <h4 class="text-base font-bold text-ink mt-0.5">
                                                <c:out value="${appointment.patientName}" />
                                            </h4>
                                            <p class="text-muted-foreground mt-1"><span
                                                    class="font-semibold text-ink">Lý do khám:</span>
                                ...
                                <c:when test="${record != null}">
                                    <div
                                        class="rounded-2xl border border-brand/10 bg-brand-soft/10 p-5 flex items-start gap-4">
                                        ...
                                        <div class="text-sm">
                                            <span
                                                class="text-xs font-bold uppercase tracking-wider text-brand-soft-foreground">Hồ
                                                sơ bệnh án #${record.recordId}</span>
                                            <h4 class="text-base font-bold text-ink mt-0.5">
                                                <c:out value="${record.patientName}" />
                                            </h4>
                                            <p class="text-muted-foreground mt-0.5"><span
                                                    class="font-semibold text-ink">Mã bệnh nhân:</span>
                            ...
                            <div class="border border-border/60 bg-muted/10 rounded-2xl p-5 md:p-6 space-y-4">
                                <div class="flex items-center gap-2 border-b border-border/40 pb-3">
                                    ...
                                    <h3 class="font-display font-bold text-base text-ink">Chỉ số sức khỏe</h3>
                                </div>

                                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-4">
                                    <div>
                                        <label
                                            class="block text-xs font-bold uppercase tracking-wide text-muted-foreground mb-1.5">Huyết
                                            áp</label>
                                    ...
                                    <div>
                                        <label
                                            class="block text-xs font-bold uppercase tracking-wide text-muted-foreground mb-1.5">Nhịp
                                            tim (bpm)</label>
                                    ...
                                    <div>
                                        <label
                                            class="block text-xs font-bold uppercase tracking-wide text-muted-foreground mb-1.5">Nhiệt
                                            độ (°C)</label>
                                    ...
                                    <div>
                                        <label
                                            class="block text-xs font-bold uppercase tracking-wide text-muted-foreground mb-1.5">Cân
                                            nặng (kg)</label>
                                    ...
                                    <div>
                                        <label
                                            class="block text-xs font-bold uppercase tracking-wide text-muted-foreground mb-1.5">Chiều
                                            cao (cm)</label>
