        ...
        <body class="flex min-h-screen bg-muted/30 font-sans text-ink">
            ...
            <aside class="hidden w-64 shrink-0 flex-col border-r border-border/60 bg-card md:flex">
                ...
                <nav class="flex-1 space-y-1 px-4 py-4">
                    <a href="${pageContext.request.contextPath}/admin/index"
                        class="flex items-center gap-3 rounded-lg bg-brand-soft px-3 py-2 text-sm font-semibold text-brand">
                    ...
                    <a href="${pageContext.request.contextPath}/admin/users"
                        class="flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium text-muted-foreground hover:bg-muted transition">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <main class="flex-1 p-8 overflow-y-auto">
                <div class="flex justify-between items-center mb-8">
                    ...
                    <div class="text-sm text-gray-500">Ngày hôm nay: <span id="currentDate"
                            class="font-semibold text-gray-700"></span></div>
                </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    <div class="lg:col-span-2 chart-container">
                        <h3 class="text-lg font-semibold text-gray-700 mb-4">Lịch hẹn theo tháng (Tất cả)
                        </h3>
            ...
            <script>
                ...
                const monthlyData = JSON.parse('${monthlyJson}');
