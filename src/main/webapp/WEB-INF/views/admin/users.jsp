                        ...
                        <div class="group rounded-xl border border-border bg-card p-6 transition hover:shadow-lg">
                            <div class="mb-4 flex items-start justify-between">
                                <div class="flex items-center gap-3">
                                    <div class="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-brand-soft text-brand font-bold text-lg">
                                        <c:out value="${user.fullName.substring(0,2).toUpperCase()}"/>
                                    </div>
                                    <div>
                            ...
                            <div class="flex gap-2 border-t border-border pt-4">
                                ...
                                <a href="${pageContext.request.contextPath}/admin/users?action=delete&id=${user.userId}" 
                                   ...
                                   class="flex-1 rounded-lg bg-red-100 px-3 py-2 text-center text-xs font-medium text-red-800 hover:bg-red-200 transition">
                                    Xóa
                                </a>
                            </div>
                        </div>
