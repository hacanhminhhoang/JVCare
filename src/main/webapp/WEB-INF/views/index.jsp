<%@ page contentType="text/html;charset=UTF-8" language="java" %>
  ...
  <body class="min-h-screen bg-background font-sans text-ink antialiased">
        ...
        <a href="${pageContext.request.contextPath}/" class="flex items-center gap-2">
          <div
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
              ...
              <path
                d="m10 13-1.4 1.6c-.6.7-1.7 1.9-1.7 3.2 0 1.6 1.4 2.9 3.1 2.9 1.7 0 3.1-1.3 3.1-2.9 0-1.3-1.1-2.5-1.7-3.2L10 13Z" />
            </svg>
          </div>
    ...
    <main>
      ...
      <section class="relative overflow-hidden">
        ...
        <div class="mx-auto grid max-w-7xl gap-16 px-6 py-20 lg:grid-cols-[1.05fr_1fr] lg:items-center lg:py-28">
          <div>
            <div
              class="inline-flex items-center gap-2 rounded-full border border-brand/20 bg-brand-soft px-3 py-1 text-xs font-semibold text-brand">
              <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none"
                stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                <path
            ...
            <div class="mt-10 flex items-center gap-6 text-sm text-muted-foreground">
              <div class="flex items-center gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                  class="text-brand" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                  stroke-linecap="round" stroke-linejoin="round">
                  <polyline points="20 6 9 17 4 12" />
                </svg> Không cần thẻ tín dụng</div>
              <div class="flex items-center gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                  class="text-brand" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                  stroke-linecap="round" stroke-linejoin="round">
                  <polyline points="20 6 9 17 4 12" />
                </svg> Triển khai trong 24h</div>
            </div>
          </div>
          <div class="relative">
            <div
              class="absolute -inset-6 -z-10 rounded-[2rem] bg-gradient-to-tr from-brand/20 via-transparent to-accent/30 blur-2xl">
            </div>
            <img src="${pageContext.request.contextPath}/images/hero-doctor.jpg"
              alt="Bác sĩ sử dụng JVCare để xem bệnh án điện tử trên máy tính bảng"
              class="rounded-3xl border border-border/60 shadow-2xl shadow-brand/10 w-full" />
            <div
              class="absolute -bottom-6 -left-6 hidden rounded-2xl border border-border bg-card p-4 shadow-xl sm:block">
              <div class="flex items-center gap-3">
      ...
      <section class="border-y border-border/60 bg-muted/30">
        <div class="mx-auto flex max-w-7xl flex-wrap items-center justify-center gap-x-12 gap-y-4 px-6 py-8">
          <p class="text-xs font-semibold uppercase tracking-widest text-muted-foreground">Được tin dùng bởi 200+ cơ sở
            y tế</p>
      ...
      <section id="features" class="mx-auto max-w-7xl px-6 py-24">
        <div class="max-w-2xl">
          ...
          <h2 class="mt-3 font-display text-4xl font-bold tracking-tight text-ink lg:text-5xl">Tất cả những gì cơ sở y
            tế cần — trong một nền tảng.</h2>
        </div>
        <div class="mt-16 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          <div
            class="group relative rounded-2xl border border-border bg-card p-7 transition hover:-translate-y-1 hover:border-brand/40 hover:shadow-xl hover:shadow-brand/5">
            <div
              class="flex h-12 w-12 items-center justify-center rounded-xl bg-brand-soft text-brand transition group-hover:bg-brand group-hover:text-brand-foreground">
            ...
            <p class="mt-2 text-sm leading-relaxed text-muted-foreground">Tạo, lưu trữ và truy xuất hồ sơ bệnh nhân chỉ
              trong vài giây với giao diện tinh gọn.</p>
          </div>
          <div
            class="group relative rounded-2xl border border-border bg-card p-7 transition hover:-translate-y-1 hover:border-brand/40 hover:shadow-xl hover:shadow-brand/5">
            <div
            ...
            <p class="mt-2 text-sm leading-relaxed text-muted-foreground">Mã hoá AES-256, tuân thủ HIPAA & Nghị định
              13/2023 về bảo vệ dữ liệu cá nhân.</p>
          </div>
          <div
            class="group relative rounded-2xl border border-border bg-card p-7 transition hover:-translate-y-1 hover:border-brand/40 hover:shadow-xl hover:shadow-brand/5">
            <div
            ...
            <p class="mt-2 text-sm leading-relaxed text-muted-foreground">Gợi ý chẩn đoán dựa trên triệu chứng và lịch
              sử khám, tăng độ chính xác lên 35%.</p>
          </div>
          <div
            class="group relative rounded-2xl border border-border bg-card p-7 transition hover:-translate-y-1 hover:border-brand/40 hover:shadow-xl hover:shadow-brand/5">
            <div
            ...
            <p class="mt-2 text-sm leading-relaxed text-muted-foreground">Tự động hoá nhập liệu, kê đơn và in phiếu —
              bác sĩ tập trung vào bệnh nhân.</p>
          </div>
          <div
            class="group relative rounded-2xl border border-border bg-card p-7 transition hover:-translate-y-1 hover:border-brand/40 hover:shadow-xl hover:shadow-brand/5">
            <div
            ...
            <p class="mt-2 text-sm leading-relaxed text-muted-foreground">Bệnh nhân tra cứu hồ sơ, đặt lịch tái khám và
              nhận đơn thuốc qua ứng dụng di động.</p>
          </div>
          <div
            class="group relative rounded-2xl border border-border bg-card p-7 transition hover:-translate-y-1 hover:border-brand/40 hover:shadow-xl hover:shadow-brand/5">
            <div
            ...
            <p class="mt-2 text-sm leading-relaxed text-muted-foreground">Kiểm soát truy cập theo vai trò: bác sĩ, điều
              dưỡng, lễ tân, quản lý.</p>
          </div>
        </div>
      </section>
      ...
      <section id="workflow" class="relative bg-gradient-to-b from-muted/40 to-background py-24">
        <div class="mx-auto max-w-7xl px-6">
          <div class="max-w-2xl">
            ...
            <h2 class="mt-3 font-display text-4xl font-bold tracking-tight text-ink lg:text-5xl">Một dòng chảy liền mạch
              — từ tiếp đón đến tái khám.</h2>
          </div>
          <div class="mt-16 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            <div class="rounded-2xl border border-border bg-card p-7">
              ...
              <p class="mt-2 text-sm leading-relaxed text-muted-foreground">Quét CCCD/BHYT, tự động tạo hồ sơ bệnh nhân
                trong 10 giây.</p>
            </div>
            <div class="rounded-2xl border border-border bg-card p-7">
              ...
              <p class="mt-2 text-sm leading-relaxed text-muted-foreground">Bác sĩ nhập triệu chứng, AI gợi ý chẩn đoán
                và xét nghiệm cần thiết.</p>
            </div>
            <div class="rounded-2xl border border-border bg-card p-7">
              ...
              <p class="mt-2 text-sm leading-relaxed text-muted-foreground">Đơn thuốc điện tử kết nối nhà thuốc, tích
                hợp thanh toán không tiền mặt.</p>
            </div>
            <div class="rounded-2xl border border-border bg-card p-7">
              ...
              <p class="mt-2 text-sm leading-relaxed text-muted-foreground">Tự động nhắc lịch, gửi kết quả qua app cho
                bệnh nhân.</p>
            </div>
          </div>
        </div>
    ...
    <footer class="border-t border-border bg-background">
      <div
        class="mx-auto flex max-w-7xl flex-col items-start justify-between gap-6 px-6 py-10 sm:flex-row sm:items-center">
        <div>
          <a href="${pageContext.request.contextPath}/" class="flex items-center gap-2">
            <span class="font-display text-xl font-bold tracking-tight text-ink">JV<span
                class="text-brand">Care</span></span>
          </a>
